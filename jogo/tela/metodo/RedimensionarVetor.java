...
//        int quente = 0;
        ...
        // agua == 0
        if (classe1 != null && !classe1.equalsIgnoreCase("Sem classe") && !classe1.equalsIgnoreCase("")) {
            ...
            if (classe2 != null && !classe1.equalsIgnoreCase("Sem classe") && !classe2.equalsIgnoreCase("Sem classe")) {
                ...
                if (classe3 != null && !classe1.equalsIgnoreCase("Sem classe") && !classe2.equalsIgnoreCase("Sem classe") && !classe3.equalsIgnoreCase("Sem classe")
                    ...
                    switch (classe3.toLowerCase()) {
                        case "arqueiro":
                            // Verificar se a classe1 está como Arqueiro
                            personagem[2] = new Arqueiro(player3, vida3, mana, dano3);
                            break;
                        case "assassino":
                            // Verificar se a classe1 está como Assassino
                            personagem[2] = new Assassino(player3, vida3, mana, dano3);
                            break;
                        case "bardo":
                            // Verificar se a classe1 está como Bardo
                            personagem[2] = new Bardo(player3, vida3, mana, dano3);
                            break;
                        case "guerreiro":
                            // Verificar se a classe1 está como Guerreiro
                            personagem[2] = new Guerreiro(player3, vida3, mana, dano3);
                            break;
                        case "mago":
                            // Verificar se a classe1 está como Mago
                            personagem[2] = new Mago(player3, vida3, mana, dano3);
                            break;
                        default:
                            // Caso a classe1 não corresponda a nenhuma das opções anteriores
                            JOptionPane.showMessageDialog(null, "Erro de redimensionar vetor: Jogador 3 com classe inválida");
                            break;
                    }
